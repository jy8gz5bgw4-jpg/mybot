...
CHANNEL_USERNAME = "@ELVINPODPISKA"
...
callback_data="telegram")]]
            await update.message.reply_text(
                "✅ Ты подписан на канал! Нажимай 'Telegram' для 
участия.",
                reply_markup=InlineKeyboardMarkup(keyboard)
            )
        else:
            await update.message.reply_text(f"❌ Подпишись на 
{CHANNEL_USERNAME} и нажми /start.")
    except:
        await update.message.reply_text("Ошибка. Добавь бота в админы 
канала.")
